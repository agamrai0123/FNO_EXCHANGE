...
type Order struct {
	...
	CseId                string  `json:"cse_id"` //added in ROUT
	PipeId               string  `json:"pipe_id"`
	CtclId               string  `json:"ctcl_id"`
	ProductType          rune    `json:"product_type"`
	Underlying           string  `json:"underlying"`
	ExpiryDate           string  `json:"expiry_date"`
	ExcerciseType        string  `json:"excercise_type"`
	OptionType           string  `json:"option_type"`
	StrikePrice          uint32  `json:"strike_price"`
	IndexOrStock         rune    `json:"index_or_stock"`
	CALevel              string  `json:"ca_level"`
	ActionId             string  `json:"action_id"`       // in spn_plc_ord error
	...
	TotalOrderQuantity   uint32  `json:"total_order_quantity"`
	LimitRate            uint32  `json:"limit_rate"`
	StopLossTrigger      uint32  `json:"stop_loss_trigger"`
	...
	SpreadOrderIndicator string  `json:"spread_order_indicator"`
