...
const (
	Ingest_SendOrder_FullMethodName = "/order.Ingest/SendOrder"
)
...
func (c *ingestClient) SendOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
	err := c.cc.Invoke(ctx, Ingest_SendOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIngestServer) SendOrder(context.Context, *Order) (*OrderResponse, error) {
...
func _Ingest_SendOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Order)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServer).SendOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ingest_SendOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServer).SendOrder(ctx, req.(*Order))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Ingest_SendOrder_Handler,
		},
	},
