...
type Order struct {
	...
	CseId                int32                  `protobuf:"varint,6,opt,name=cse_id,json=cseId,proto3" json:"cse_id,omitempty"`
	...
	StrikePrice          int32                  `protobuf:"varint,14,opt,name=strike_price,json=strikePrice,proto3" json:"strike_price,omitempty"`
	IndexOrStock         string                 `protobuf:"bytes,15,opt,name=index_or_stock,json=indexOrStock,proto3" json:"index_or_stock,omitempty"`
	CaLevel              int32                  `protobuf:"varint,16,opt,name=ca_level,json=caLevel,proto3" json:"ca_level,omitempty"`
	ActionId             int32                  `protobuf:"varint,17,opt,name=action_id,json=actionId,proto3" json:"action_id,omitempty"`
	...
	DisclosedQuantity    int32                  `protobuf:"varint,24,opt,name=disclosed_quantity,json=disclosedQuantity,proto3" json:"disclosed_quantity,omitempty"`
	TotalOrderQuantity   int32                  `protobuf:"varint,25,opt,name=total_order_quantity,json=totalOrderQuantity,proto3" json:"total_order_quantity,omitempty"`
	LimitRate            int32                  `protobuf:"varint,26,opt,name=limit_rate,json=limitRate,proto3" json:"limit_rate,omitempty"`
	StopLossTrigger      int32                  `protobuf:"varint,27,opt,name=stop_loss_trigger,json=stopLossTrigger,proto3" json:"stop_loss_trigger,omitempty"`
...
func (x *Order) GetStrikePrice() int32 {
	if x != nil {
...
func (x *Order) GetActionId() int32 {
	if x != nil {
		return x.ActionId
	}
	return 0
...
func (x *Order) GetDisclosedQuantity() int32 {
	if x != nil {
...
func (x *Order) GetTotalOrderQuantity() int32 {
	if x != nil {
...
func (x *Order) GetLimitRate() int32 {
	if x != nil {
		return x.LimitRate
	}
	return 0
...
func (x *Order) GetStopLossTrigger() int32 {
	if x != nil {
...
var file_order_proto_rawDesc = string([]byte{
	...
	0x05, 0x52, 0x05, 0x63, 0x73, 0x65, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x69, 0x70, 0x65,
	...
	0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x73, 0x74,
	...
	0x05, 0x52, 0x07, 0x63, 0x61, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x61,
	...
	0x5f, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x18, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	0x72, 0x5f, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x19, 0x20, 0x01, 0x28, 0x05,
	...
	0x74, 0x65, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x52,
	0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x6c, 0x6f, 0x73, 0x73,
	0x5f, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f,
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x39, 0x0a, 0x06, 0x49, 0x6e,
	0x67, 0x65, 0x73, 0x74, 0x12, 0x2f, 0x0a, 0x09, 0x53, 0x65, 0x6e, 0x64, 0x4f, 0x72, 0x64, 0x65,
...
var file_order_proto_depIdxs = []int32{
	0, // 0: order.Ingest.SendOrder:input_type -> order.Order
	1, // 1: order.Ingest.SendOrder:output_type -> order.OrderResponse
